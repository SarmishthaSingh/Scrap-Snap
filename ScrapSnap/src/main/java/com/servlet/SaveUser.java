...
try {
		...
		User deal=new User(0, name, number, email, password, metal, paper, plastic, gender, new Date(0));
    ...
    out.println("<h1 style='text-align:center;'><a href='all_Userdata.jsp'>View all Data</a> </h1>");
