...
<title>Scrap Dealer Login page</title>
                 ...
                 <div class="col-md-4 offset-md-4">
                     <div class="card mt-4">
                         <div class="card-header text-center text-white bg-custom">
                          ...
                          <h4 style="color:Green;Background-color:Black;">Dealer Login </h4>
                         </div>  
                         <div class="card-body">
                             <form action="dealersign.jsp" method="post">
                    ...
                    <button type="submit" class="btn btn-primary bodge-pill btn-block" value="Login">Login</button><br>
